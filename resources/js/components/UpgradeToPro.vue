<template>
  ...
  >
    ...
    >
      <VCard>
        <VImg src="https://cdn.themeselection.com/ts-assets/materio/materio-vuetify-vuejs-laravel-admin-template/banner/banner.png" />
        ...
        <VCardText>
          <VBtn
            class="me-4"
            href="https://themeselection.com/item/materio-vuetify-vuejs-laravel-admin-template/?tab=details#details"
            target="_blank"
            rel="noopener noreferrer"
          >
            Demo
